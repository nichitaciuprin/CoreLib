    ...
    while (!WindowShouldClose())
    {
        ...
        BeginTextureMode(target);
            ...
            BeginMode3D(camera);
            {
                ...
                {
                    Vector3 pos1 = (Vector3){  0.0f,  0.0f,  1.0f };
                    Vector3 pos2 = (Vector3){  0.0f,  0.0f, -1.0f };
                    Vector3 size = (Vector3){  1.0f,  1.0f,  1.0f };
                    DrawCubeWiresV (pos1, size, RED);
                    DrawCubeV      (pos1, size, PURPLE);
                    DrawCubeWiresV (pos2, size, DARKGREEN);
                    DrawCubeV      (pos2, size, YELLOW);
                    DrawGrid(10, 1.0f);
                }
                EndShaderMode();
            }
